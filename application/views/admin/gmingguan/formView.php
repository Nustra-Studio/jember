<?=content_open('Halaman Grafik Mingguan')?>
<div class="col-md-6">
                    <div class="row" style="margin-right: 2px; margin-left: 2px">
                    <?php 
                   $data_peminjaman_buku = $this->db->query("SELECT COUNT(id_hotspot) AS jumlah, DATE_FORMAT(tgl,'%M') AS pinjam_bulan FROM t_hotspot GROUP BY DATE_FORMAT(tgl,'%M')")->result();
