...
class KategorikeluhanModel extends CI_Model{
	function get(){
		$data=$this->db->get('m_keluhan');
		return $data;
	}
	function insert($data=array()){
		$this->db->insert('m_keluhan',$data);
