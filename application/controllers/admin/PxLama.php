...
class PxLama extends CI_Controller {
	...
	{
		$datacontent['url']='admin/pxlama';
		$datacontent['title']='Halaman Register Pasien Lama';
		$datacontent['datatable']=$this->Model->get();
		$data['content']=$this->load->view('admin/pxlama/tableView',$datacontent,TRUE);
		$data['js']=$this->load->view('admin/pxlama/js/tableJs',$datacontent,TRUE);
	...
	public function form($parameter='',$id='')
	{
		...
		$datacontent['id']=$id;
		$datacontent['title']='Form Register Pasien Lama';
		$data['content']=$this->load->view('admin/pxlama/formView',$datacontent,TRUE);
		$data['js']=$this->load->view('admin/pxlama/js/formJs',$datacontent,TRUE);
		$data['title']=$datacontent['title'];
		$this->load->view('admin/layouts/html',$data);
	}
	...
	public function export($jenis='pdf'){
		if($jenis=='pdf'){
			...
			$datacontent['datatable']=$this->Model->get();
			$html=$this->load->view('admin/pxlama/pdfView',$datacontent,TRUE);
